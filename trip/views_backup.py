...
def create_booking(request):
    ...
    try:
        ...
        if booking_type == 'passenger':
            ...
            print(f"Passenger booking - Adults: {booking.adult_passengers}, Children: {booking.child_passengers}")
            print(f"Adult fare: {booking.adult_fare_rate}, Child fare: {booking.child_fare_rate}")
...
def payment_view(request, booking_reference):
    try:
        ...
        if booking.booking_type == 'passenger':
            ...
            payment_amount = (adult_passengers * adult_fare) + (child_passengers * child_fare)
            print(f"Passenger booking - Adults: {adult_passengers} x ₱{adult_fare} = ₱{adult_passengers * adult_fare}")
            print(f"Passenger booking - Children: {child_passengers} x ₱{child_fare} = ₱{child_passengers * child_fare}")
...
d e f   b o o k i n g ( r e q u e s t ) :  
         " " " V i e w   f o r   d i s p l a y i n g   a n d   h a n d l i n g   t h e   p a s s e n g e r   b o o k i n g   f o r m " " "  
         #   G e t   u p c o m i n g   s c h e d u l e s   f o r   t h e   d r o p d o w n  
         s c h e d u l e s   =   S c h e d u l e . o b j e c t s . f i l t e r (  
                 d e p a r t u r e _ d a t e t i m e _ _ g t = t i m e z o n e . n o w ( ) ,  
                 s t a t u s = ' s c h e d u l e d '  
         ) . o r d e r _ b y ( ' d e p a r t u r e _ d a t e t i m e ' )  
  
         #   C h e c k   i f   a   s p e c i f i c   s c h e d u l e   w a s   s e l e c t e d  
         s e l e c t e d _ s c h e d u l e   =   N o n e  
         i f   r e q u e s t . G E T . g e t ( ' s c h e d u l e ' ) :  
                 t r y :  
                         s e l e c t e d _ s c h e d u l e   =   S c h e d u l e . o b j e c t s . g e t ( i d = r e q u e s t . G E T . g e t ( ' s c h e d u l e ' ) )  
                         #   P r e - c a l c u l a t e   t h e   f a r e   r a t e s   f o r   J a v a S c r i p t  
                         a d u l t _ f a r e   =   s e l e c t e d _ s c h e d u l e . a d u l t _ f a r e  
                         c h i l d _ f a r e   =   s e l e c t e d _ s c h e d u l e . c h i l d _ f a r e  
                 e x c e p t   S c h e d u l e . D o e s N o t E x i s t :  
                         m e s s a g e s . e r r o r ( r e q u e s t ,   " T h e   s e l e c t e d   s c h e d u l e   d o e s   n o t   e x i s t . " )  
                         r e t u r n   r e d i r e c t ( ' b o o k i n g ' )  
  
         c o n t e x t   =   {  
                 ' s c h e d u l e s ' :   s c h e d u l e s ,  
                 ' s e l e c t e d _ s c h e d u l e ' :   s e l e c t e d _ s c h e d u l e ,  
         }  
  
         r e t u r n   r e n d e r ( r e q u e s t ,   ' b o o k i n g . h t m l ' ,   c o n t e x t )  
  
 d e f   v e h i c l e _ b o o k i n g ( r e q u e s t ) :  
         " " " V i e w   f o r   d i s p l a y i n g   a n d   h a n d l i n g   t h e   v e h i c l e   b o o k i n g   f o r m " " "  
         #   G e t   u p c o m i n g   s c h e d u l e s   f o r   t h e   d r o p d o w n  
         s c h e d u l e s   =   S c h e d u l e . o b j e c t s . f i l t e r (  
                 d e p a r t u r e _ d a t e t i m e _ _ g t = t i m e z o n e . n o w ( ) ,  
                 s t a t u s = ' s c h e d u l e d '  
         ) . o r d e r _ b y ( ' d e p a r t u r e _ d a t e t i m e ' )  
  
         #   G e t   a l l   v e h i c l e   t y p e s   f o r   t h e   v e h i c l e   b o o k i n g   f o r m  
         v e h i c l e _ t y p e s   =   V e h i c l e T y p e . o b j e c t s . a l l ( )  
  
         #   C h e c k   i f   a   s p e c i f i c   s c h e d u l e   w a s   s e l e c t e d  
         s e l e c t e d _ s c h e d u l e   =   N o n e  
         i f   r e q u e s t . G E T . g e t ( ' s c h e d u l e ' ) :  
...
                 e x c e p t   S c h e d u l e . D o e s N o t E x i s t :  
                         m e s s a g e s . e r r o r ( r e q u e s t ,   " T h e   s e l e c t e d   s c h e d u l e   d o e s   n o t   e x i s t . " )  
                         r e t u r n   r e d i r e c t ( ' v e h i c l e _ b o o k i n g ' )  
  
         c o n t e x t   =   {  
                 ' s c h e d u l e s ' :   s c h e d u l e s ,  
                 ' v e h i c l e _ t y p e s ' :   v e h i c l e _ t y p e s ,  
                 ' s e l e c t e d _ s c h e d u l e ' :   s e l e c t e d _ s c h e d u l e ,  
         }  
  
         r e t u r n   r e n d e r ( r e q u e s t ,   ' v e h i c l e _ b o o k i n g . h t m l ' ,   c o n t e x t )  
 d e f   b o o k i n g ( r e q u e s t ) :  
         " " " V i e w   f o r   d i s p l a y i n g   a n d   h a n d l i n g   t h e   p a s s e n g e r   b o o k i n g   f o r m " " "  
         #   G e t   u p c o m i n g   s c h e d u l e s   f o r   t h e   d r o p d o w n  
         s c h e d u l e s   =   S c h e d u l e . o b j e c t s . f i l t e r (  
